    ...
    task.spawn(function()
        ...
        UpdateSize()
            ...
            function Items:AddCard(CardConfig)
                ...
                local hasBadge = CardConfig.Badge and CardConfig.Badge ~= ""
                if hasBadge then cardHeight = cardHeight + 16 end
                ...
                CardStroke.Color = Color3.fromRGB(45, 48, 62)
                ...
                if hasBadge then
                    ...
                    Badge.Text = string.upper(tostring(CardConfig.Badge))
                    Badge.TextColor3 = Color3.fromRGB(255, 255, 255)
                    Badge.TextSize = 10
                    Badge.AutomaticSize = Enum.AutomaticSize.X
                    Badge.BackgroundColor3 = CardConfig.BadgeColor or (GuiConfig.Color or Color3.fromRGB(90, 140, 255))
                    Badge.BackgroundTransparency = 0
                    Badge.Position = UDim2.new(0, cx, 0, 10)
                ...
                CardTitle.Position = UDim2.new(0, cx, 0, 12 + badgeOffset)
                ...
                CardDesc.TextColor3 = Color3.fromRGB(150, 152, 165)
                CardDesc.TextSize = 11
                CardDesc.TextXAlignment = Enum.TextXAlignment.Left
                CardDesc.TextYAlignment = Enum.TextYAlignment.Top
                CardDesc.TextWrapped = true
                CardDesc.BackgroundTransparency = 1
                CardDesc.Position = UDim2.new(0, cx, 0, 30 + badgeOffset)
                ...
                if #btns > 0 then
                    ...
                    Row.Position = UDim2.new(0, 10, 0, cardHeight - 38)
                    ...
                    for _, bd in ipairs(btns) do
                        ...
                        Btn.TextSize = 12
                        Btn.BackgroundColor3 = bd.Color or GuiConfig.Color or Color3.fromRGB(90, 140, 255)
